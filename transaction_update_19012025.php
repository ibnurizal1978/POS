...
<body class="bg-gray-100">
    ...
    <script>
        ...
        function addItem(product) {
            ...
            if (existingItem) {
                if (existingItem.quantity < product.stock) {
                    ...
                    // Show toast error if quantity exceeds stock
                    showToast('Stok tidak cukup untuk produk ini', 'error');
                    return; // Stop execution if stock is not enough
                }
            } else {
                if (product.stock > 0) {
                    items.push({
                    ...
                    // Show toast error if stock is empty
        ...
        function processTransaction() {
            console.log('Inside processTransaction function'); // Debugging
