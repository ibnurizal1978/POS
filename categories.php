...
$stmt = $conn->prepare("SELECT COUNT(id) as total FROM categories WHERE is_active = 1 AND store_id = ?");
...
$query = "
    ...
    FROM categories 
    WHERE is_active = 1 AND store_id = ? 
    ORDER BY name ASC 
    LIMIT " . (int)$limit . " 
    OFFSET " . (int)$offset;
        ...
        <div class="bg-white shadow-sm">
            <div class="max-w-7xl mx-auto px-4 py-4">
                <div class="flex justify-between items-center">
                    ...
                    <h1 class="text-lg font-semibold text-gray-800">Kategori Produk</h1>
                    <a href="category-add" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-medium">
            ...
            <div class="bg-white rounded-lg shadow-sm">
                <div id="categories-container" class="divide-y divide-gray-100">
                    ...
                    <div class="p-8 text-center">
                        ...
                        <a href="category-add" class="inline-flex items-center text-blue-500 hover:text-blue-600 font-medium">
                    ...
                    <div class="p-4 flex items-center justify-between hover:bg-gray-50">
                        ...
                        <a href="category-edit?id=<?php echo Encryption::encode($category['id']); ?>" 
